...
import com.example.guo.adapter.ViewPager2Adapter
import com.example.guo.databinding.FragmentBottomSheetTabVp2Binding
...
class TabVP2BottomSheetDialogFragment : BottomSheetDialogFragment() {
    companion object {
        ...
        fun newInstance(): TabVP2BottomSheetDialogFragment = TabVP2BottomSheetDialogFragment()
    }
    ...
    private fun FragmentBottomSheetTabVp2Binding.initTab() {
        ...
        val adapter = ViewPager2Adapter(childFragmentManager, lifecycle, fragments)
        vp2.adapter = adapter
