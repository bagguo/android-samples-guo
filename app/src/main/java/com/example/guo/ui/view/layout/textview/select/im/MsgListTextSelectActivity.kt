package com.example.guo.ui.view.layout.textview.select.im
...
import com.example.guo.widgets.text.select.im.MsgAdapter
import com.example.guo.widgets.text.select.im.MsgBean
import com.example.guo.widgets.text.select.im.SelectTextEvent
...
class MsgListTextSelectActivity : AppCompatActivity() {
    companion object {
        fun start(context: Context) {
            val intent = Intent(context, MsgListTextSelectActivity::class.java)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_msg_list_text_select)
