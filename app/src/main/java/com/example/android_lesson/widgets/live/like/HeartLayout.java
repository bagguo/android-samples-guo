package com.example.android_lesson.widgets.live.like;
...
public class HeartLayout extends RelativeLayout {
    ...
    private int[] hearts = new int[]{//
            R.drawable.ic_kudos1, R.drawable.ic_kudos2,//
            R.drawable.ic_kudos3, R.drawable.ic_kudos4, //
            R.drawable.ic_kudos5, R.drawable.ic_kudos6,//
