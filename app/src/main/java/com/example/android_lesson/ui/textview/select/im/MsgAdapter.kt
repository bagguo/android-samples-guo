package com.example.android_lesson.ui.textview.select.im
...
import com.example.android_lesson.ui.textview.select.im.SelectTextHelper.OnSelectListener
    ...
    internal inner class ViewHolderText(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun handleSelector(event: SelectTextEvent) {
            ...
            when (type) {
                ...
                "dismissAllPopDelayed" -> postReset(RESET_DELAY)
            }
        }
